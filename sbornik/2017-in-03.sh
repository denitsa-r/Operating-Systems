...
# echo "s45194:x:1255:502:Elizabet Mihaylova, Inf, k3, g1:/home/Inf/s45194:/bin/bash
...
# s45216:x:1235:502:Aleksandar Yavashev, Inf, k3, g3:/home/Inf/s45216:/bin/bash" > pract/mypasswd

cat pract/mypasswd | grep "/home/Inf" | grep -E "^s[^ ]*([^ ]*:){3}[A-Z][a-z]+ [A-Z][a-z]+a[,|:]" | cut -d ':' -f 1 | cut -c 3,4 | sort | uniq -c